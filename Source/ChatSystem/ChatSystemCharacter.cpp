...
void AChatSystemCharacter::BeginPlay()
{
	// Call the base class  
	Super::BeginPlay();
	CurrentMessage = "";
...
void AChatSystemCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AChatSystemCharacter::Move);
...
void AChatSystemCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AChatSystemCharacter::GetLifetimeReplicatedProps(TArray<FLifetimeProperty>& OutLifetimeProps) const
{
	...
	DOREPLIFETIME(AChatSystemCharacter, CurrentMessage);
